...
class AuthenticationService:
    ...
    async def get_access_token(self) -> str:
        ...
        print(
            "AUTH DEBUG 1: "
            "AuthenticationService.get_access_token()"
        )
        ...
        if cached:
            print("AUTH DEBUG: Using cached access token")
        ...
        async with lock:
            ...
            if cached:
                print(
                    "AUTH DEBUG: Token generated by another request"
                )
                return cached.access_token
            ...
            print(
                "AUTH DEBUG: Requesting new Business Central token"
            )
            ...
            print(
                "AUTH DEBUG 2: "
                "New Business Central token received"
            )
    ...
    async def force_refresh(self) -> str:
        ...
        async with lock:
            ...
            print(
                "AUTH DEBUG: Force refreshing Business Central token"
            )
    ...
    async def _request_new_token(self) -> OAuthToken:
        ...
        print("Tenant ID:", CredentialProvider.get_tenant_id())
        print("Client ID:", CredentialProvider.get_client_id())
